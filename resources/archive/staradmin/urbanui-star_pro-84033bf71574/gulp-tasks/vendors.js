...
gulp.task('buildOptionalVendorScripts', function() {
    ...
    var aScript3 = gulp.src(['node_modules/jquery-sparkline/jquery.sparkline.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/jquery-sparkline')); 
    var aScript4 = gulp.src(['node_modules/progressbar.js/dist/progressbar.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/progressbar.js'));
    ...
    var aScript9 = gulp.src(['node_modules/chartist/dist/chartist.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/chartist'));
    var aScript10 = gulp.src(['node_modules/flot/jquery.flot.js'])
        .pipe(gulp.dest('./src/assets/vendors/flot'));
    ...
    var aScript33 = gulp.src(['node_modules/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/bootstrap-datepicker'));
    ...
    var aScript43 = gulp.src(['node_modules/quill/dist/quill.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/quill'));
    ...
    var aScript45 = gulp.src(['node_modules/jquery-validation/dist/jquery.validate.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/jquery-validation'));
    ...
    var aScript47 = gulp.src(['node_modules/jquery-steps/build/jquery.steps.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/jquery-steps'));
    var aScript48 = gulp.src(['node_modules/jquery-mapael/js/jquery.mapael.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/jquery-mapael'));   
    ...
    var aScript52 = gulp.src(['node_modules/jvectormap/jquery-jvectormap.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/jvectormap'));
    ...
    var aScript55 = gulp.src(['node_modules/datatables.net/js/jquery.dataTables.js'])
        .pipe(gulp.dest('./src/assets/vendors/datatables.net'));
    var aScript56 = gulp.src(['node_modules/datatables.net-bs4/js/dataTables.bootstrap4.js'])
        .pipe(gulp.dest('./src/assets/vendors/datatables.net-bs4'));
    ...
    var aScript66 = gulp.src(['node_modules/sweetalert/dist/sweetalert.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/sweetalert'));
    var aScript67 = gulp.src(['node_modules/jquery.avgrund/jquery.avgrund.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/jquery.avgrund'));
    var aScript68 = gulp.src(['node_modules/nouislider/distribute/nouislider.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/nouislider')); 
    var aScript69 = gulp.src(['node_modules/ion-rangeslider/js/ion.rangeSlider.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/ion-rangeslider/js'));
    var aScript70 = gulp.src(['./node_modules/tinymce/**/*'])
        .pipe(gulp.dest('./src/assets/vendors/tinymce'));
    var aScript71 = gulp.src(['./node_modules/icheck/icheck.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/icheck'));
    var aScript72 = gulp.src(['./node_modules/datatables.net-fixedcolumns/js/dataTables.fixedColumns.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/datatables.net-fixedcolumns'));
    var aScript73 = gulp.src(['./node_modules/jquery-circle-progress/dist/circle-progress.min.js'])
        .pipe(gulp.dest('./src/assets/vendors/jquery-circle-progress'));
    return merge(aScript1, aScript2, aScript3, aScript4, aScript5, aScript6, aScript7, aScript8, aScript9, aScript10, aScript11, aScript12, aScript13, aScript14, aScript15, aScript16, aScript17, aScript18, aScript19, aScript20, aScript21, aScript22, aScript23, aScript24, aScript25, aScript26  , aScript27, aScript28, aScript29, aScript30, aScript31, aScript32, aScript33, aScript34, aScript35, aScript36, aScript37, aScript38, aScript39, aScript40, aScript41, aScript42, aScript43, aScript44, aScript45, aScript46, aScript47, aScript48, aScript49, aScript50, aScript51, aScript52, aScript53, aScript54, aScript55, aScript56, aScript57, aScript58, aScript59, aScript60, aScript61, aScript62, aScript63, aScript64, aScript65, aScript66, aScript67, aScript68, aScript69, aScript70, aScript71, aScript72, aScript73);
});
...
gulp.task('buildOptionalVendorStyles', function() {
    ...
    var aStyle7 = gulp.src(['./node_modules/simple-line-icons/css/simple-line-icons.css'])
        .pipe(gulp.dest('./src/assets/vendors/simple-line-icons/css'));
    var aStyle8 = gulp.src(['./node_modules/simple-line-icons/fonts/*'])
        .pipe(gulp.dest('./src/assets/vendors/simple-line-icons/fonts'));
    var aStyle9 = gulp.src(['./node_modules/ti-icons/css/themify-icons.css'])
        .pipe(gulp.dest('./src/assets/vendors/ti-icons/css'));
    var aStyle10 = gulp.src(['./node_modules/ti-icons/fonts/*'])
        .pipe(gulp.dest('./src/assets/vendors/ti-icons/fonts'));         
    ...
    var aStyle31 = gulp.src(['node_modules/jquery-asColorPicker/dist/images/*'])
        .pipe(gulp.dest('./src/assets/vendors/jquery-asColorPicker/images'));
    ...
    var aStyle35 = gulp.src(['node_modules/select2-bootstrap-theme/dist/select2-bootstrap.min.css'])
        .pipe(gulp.dest('./src/assets/vendors/select2-bootstrap-theme'));
    ...
    var aStyle56 = gulp.src(['node_modules/typicons.font/src/font/*'])
        .pipe(gulp.dest('./src/assets/vendors/typicons'));
    var aStyle57 = gulp.src(['./node_modules/jstree/dist/**/*'])
        .pipe(gulp.dest('./src/assets/vendors/jstree'));
    var aStyle58 = gulp.src(['./node_modules/icheck/skins/**/*'])
        .pipe(gulp.dest('./src/assets/vendors/icheck'));
    var aStyle59 = gulp.src(['./node_modules/datatables.net-fixedcolumns-bs4/css/fixedColumns.bootstrap4.min.css'])
        .pipe(gulp.dest('./src/assets/vendors/datatables.net-fixedcolumns-bs4'));
    var aStyle60 = gulp.src(['./node_modules/puse-icons-feather/**/*'])
        .pipe(gulp.dest('./src/assets/vendors/puse-icons-feather'));
    return merge(aStyle1, aStyle2, aStyle3, aStyle4, aStyle5, aStyle6, aStyle7, aStyle8, aStyle9, aStyle10, aStyle11, aStyle12, aStyle13, aStyle14, aStyle15, aStyle16, aStyle17, aStyle18, aStyle19, aStyle20, aStyle21, aStyle22, aStyle23, aStyle24, aStyle25, aStyle26, aStyle27, aStyle28, aStyle29, aStyle30, aStyle31, aStyle32, aStyle33, aStyle34, aStyle35, aStyle36, aStyle37, aStyle38, aStyle39, aStyle40, aStyle41, aStyle42, aStyle43, aStyle44, aStyle45, aStyle46, aStyle47, aStyle48, aStyle49, aStyle50, aStyle51, aStyle52, aStyle53, aStyle54, aStyle55, aStyle56, aStyle57, aStyle58, aStyle59, aStyle60);
});
